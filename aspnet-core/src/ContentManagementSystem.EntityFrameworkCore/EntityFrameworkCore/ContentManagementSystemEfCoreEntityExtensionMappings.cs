...
public static class ContentManagementSystemEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE ContentManagementSystemModuleExtensionConfigurator CLASS (in the Domain.Shared project)
